...
1. **Clona il repository e rendi eseguibili gli script:**
   ```bash
...
**Usarli solo se:**
1. Si conosce la subscription attiva.
2. Si comprende lo scope.
3. Si è consapevoli dell’impatto delle operazioni.
